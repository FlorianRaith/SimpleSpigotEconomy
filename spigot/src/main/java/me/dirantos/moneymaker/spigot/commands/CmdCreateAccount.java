...
@CommandInfo(name = "create", permission = "moneymaker.cmd.account.create", usage = "create", description = "creates a new account", playerOnly = true)
public class CmdCreateAccount extends SubCommand {
    ...
    protected void handle(CommandSender sender, String[] args) {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(getPlugin(), () -> {
            ...
            getMessanger().send(sender, "The accountNumber is __" + account.getAccountNumber() + "__.", ChatLevel.SUCCESS);
        });
